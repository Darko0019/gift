...
export default function DomeGallery({
  ...
  const loop = (now: number) => {
    ...
    // Convert degrees per second to radians, apply delta, ensure positive direction
    const deltaRotation = (autoRotateSpeed * delta) / 1000;
    rotationRef.current.y += deltaRotation;
    
    // Normalize to keep within reasonable bounds but don't wrap
    // This prevents the direction flip
    if (rotationRef.current.y > 360) {
